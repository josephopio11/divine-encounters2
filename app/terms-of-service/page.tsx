    ...
    <main className="container mx-auto px-4 py-12">
      <div className="mx-auto max-w-4xl space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground">Last updated: May 12, 2023</p>
        </div>

        <div className="prose prose-lg max-w-none dark:prose-invert">
          <h2>Introduction</h2>
          <p>
            Welcome to Divine Encounters. These terms and conditions outline the rules and regulations for the use of
            our website.
          </p>
          <p>
            By accessing this website, we assume you accept these terms and conditions in full. Do not continue to use
            Divine Encounters if you do not accept all of the terms and conditions stated on this page.
          </p>

          <h2>License</h2>
          <p>
            Unless otherwise stated, Divine Encounters and/or its licensors own the intellectual property rights for all
            material on Divine Encounters. All intellectual property rights are reserved. You may view and/or print
            pages from divineencounters.org for your own personal use subject to restrictions set in these terms and
            conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from divineencounters.org</li>
            <li>Sell, rent or sub-license material from divineencounters.org</li>
            <li>Reproduce, duplicate or copy material from divineencounters.org</li>
            <li>
              Redistribute content from Divine Encounters (unless content is specifically made for redistribution)
            </li>
          </ul>
          ...
          <p>
            ...
            material and data ('Comments') in areas of the website. Divine Encounters does not screen, edit, publish or
            review Comments prior to their appearance on the website and Comments do not reflect the views or opinions
            of Divine Encounters, its agents or affiliates. Comments reflect the view and opinion of the person who
            posts such view or opinion.
          </p>
          <p>You are responsible for:</p>
          <ul>
            <li>Ensuring that any Comments you post comply with these Terms and Conditions</li>
            <li>Ensuring that any Comments you post do not infringe any third-party legal rights</li>
            <li>The accuracy, appropriateness and relevance of any Comments you post</li>
          </ul>
